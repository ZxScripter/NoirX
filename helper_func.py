#MAA CHOD DUNGA TRIPPY / ZAKI / OTHER FUCKERS TOO JISNE MERSE BINA PUCHE REPO USE KI KASAM SE BATA RHA HU BHENCHOD RANDI
...
from database.database import present_admin, present_channel, present_channel2, present_channel3
...
async def is_subscribed(filter, client, update):
    ...
    channels_2 = await present_channel3()  # Fetch the channels from the database
    channels = channels_1 + channels_2 + channels3 # Combine both lists
